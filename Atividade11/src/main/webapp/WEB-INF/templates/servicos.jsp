	...
	<div id="modal1" class="modal bottom-sheet">
		<div class="modal-content">
			<div class="container">
				...
				<form class="col s12" action="mvc?logica=AddService" method="post">
					<div class="row">
				...
				<c:forEach var="servico" items="${ servicos }">
					<tr>
						...
						<td><a class="modal-trigger btn yellow lighten-1"
							...
							href="mvc?logica=RemService&id=${ servico.id }">Apagar<span
								class="small material-icons">delete</span></a>
							<div id="modaledit${ servico.id }"
								class="modal modal-fixed-footer">
								<div class="modal-content">
									<h3>Editar Serviço</h3>
									<form class="col s12" action="mvc?logica=EditService"
										method="post">
